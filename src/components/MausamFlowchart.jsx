...
export function MausamFlowchart() {
  return (
    <div className={styles.FlowchartWrapper}>
      {/* Mausam Pipeline Flowchart - Horizontal */}
      <svg
        viewBox="0 0 860 320"
      ...
      {/* Mausam Pipeline Flowchart - Vertical */}
      <svg
        viewBox="0 0 380 720"
      ...
      >
        ...
        <g stroke="rgba(255,255,255,0.15)" strokeWidth="1" fill="none">
          ...
          {/* Tools Hub to Tools */}
          <path
            d="M 190 420 C 150 420, 110 440, 70 450"
            markerEnd="url(#vArrowhead)"
          />
          <line
            x1="190"
          ...
          />
          <path
            d="M 190 420 C 230 420, 270 440, 310 450"
            markerEnd="url(#vArrowhead)"
          />
        ...
        <path
          id="vMainPath"
          d="M 190 55 L 190 155 L 190 265 L 190 390 L 190 478"
          fill="none"
          stroke="none"
        />
        <path
          id="vDbPath"
          d="M 190 55 L 190 155 L 190 265 L 305 268 L 305 358"
          fill="none"
          stroke="none"
        />

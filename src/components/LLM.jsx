...
const AgentVisual = () => (
  <div className={styles.agentVisual}>
    ...
    <div
      ...
      style={{ top: "20%", left: "20%", opacity: 0.5 }}
    />
    <div
      className={styles.node}
      style={{ bottom: "30%", right: "25%", opacity: 0.6 }}
    />
    <div
      className={styles.node}
      style={{ top: "40%", right: "15%", opacity: 0.4 }}
    />
  </div>
);
    ...
    <div className={styles.container} ref={containerRef}>
      ...
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>
          I build reliable autonomous systems that solve real problems. My focus
          is on turning raw models into practical, production-ready software.
        </p>
      </header>
      ...
      <div className={styles.bentoGrid}>
        ...
        <div className={`${styles.card} ${styles.cardLarge}`}>
          ...
          <div>
            ...
            <p className={styles.cardDesc}>
              I design workflows that plan and execute tasks autonomously. My
              agents handle complex logic and correct their own errors without
              human intervention.
            </p>
          </div>
          <AgentVisual />
        ...
        <div className={styles.card}>
          ...
          <p className={styles.cardDesc}>
            I build custom servers that connect AI models to external tools and
            databases, allowing assistants to interact with your actual data.
          </p>
        ...
        <div className={styles.card}>
          ...
          <h3 className={styles.cardTitle}>Tool Calling Chatbots</h3>
          <p className={styles.cardDesc}>
            I build conversational interfaces that go beyond text. By connecting
            models to APIs and executables, I turn chatbots into powerful
            operators.
          </p>
          <div className={styles.tagContainer} style={{ marginTop: "1rem" }}>
            <span className={styles.tag}>Function Calling</span>
            <span className={styles.tag}>System Actions</span>
          </div>
        </div>
        ...
        <div className={`${styles.card} ${styles.cardWide}`}>
          ...
          <p className={styles.cardDesc}>
            I leverage the most powerful tools and frameworks in the ecosystem
        ...
        <div className={`${styles.card} ${styles.cardWide}`}>
          ...
          <div style={{ display: "flex", gap: "2rem" }}>
            <div style={{ flex: 1 }}>
              ...
              <p className={styles.cardDesc}>
                I focus on deploying reliable AI systems. From testing and
                evaluation to monitoring, I ensure your agents work in the real
                world.
              </p>
            </div>
            <div

...
export default function Aboutme(){
    ...
    <div id={styles.AboutContainer}>
        ...
        <div id={styles.AboutTextContainer} className={theme ==='LightMode' ? styles.LightMode : ''}>
            ...
            <p className={styles.AboutText}>I am a Masters student with a strong foundation in Full Stack Web Development &amp; Data Structures and Algorithms.</p>
            <p className={styles.AboutText}>I have demonstrated good proficiency in Data Structures and Algorithms, by successfully solving over <b>300+ problems</b> over a span of a couple of years hosted on various coding platforms. Hence acquiring a deep knowledge and understanding of DSA.</p>

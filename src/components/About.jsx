...
export default function Aboutme(){
    ...
    <div id={styles.AboutContainer}>
        ...
        <div id={styles.AboutTextContainer} className={theme ==='LightMode' ? styles.LightMode : ''}>
            ...
            <p className={styles.AboutText}>I have demonstrated good proficiency in Data Structures and Algorithms, by successfully solving over <b>350+ problems</b> over a span of a couple of years hosted on various coding platforms. Hence acquiring a deep knowledge and understanding of DSA.</p>

...
import styles from "./style/TechStackItem.module.css";

// Data structure similar to user's provided tech stack
const tech = {
  Frontend: [
    "Next.js",
    "React",
  ...
  "AI & ML": ["LLMs", "Machine Learning", "RAG", "LangChain", "Vercel AI SDK"],
